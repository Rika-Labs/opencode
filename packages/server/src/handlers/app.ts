...
import { AppNotFoundError, ForbiddenError } from "@opencode/protocol/errors"
import { APP_TICKET_QUERY, appAssetCookieName } from "@opencode/protocol/groups/app"
    ...
    return handlers
      ...
      .handleRaw(
        ...
        Effect.fn("AppHandler.asset")(function* (ctx) {
          ...
          if (ServerAuth.required(serverAuth) && (yield* authorizedRequest(ctx.request, serverAuth)))
            return yield* serve
