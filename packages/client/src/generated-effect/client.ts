...
type Endpoint13_0Request = Parameters<RawClient["server.mcp"]["mcp.status"]>[0]
...
type Endpoint13_1Request = Parameters<RawClient["server.mcp"]["mcp.tool.list"]>[0]
type Endpoint13_1Input = {
  readonly location?: Endpoint13_1Request["query"]["location"]
  readonly server?: Endpoint13_1Request["query"]["server"]
}
const Endpoint13_1 = (raw: RawClient["server.mcp"]) => (input?: Endpoint13_1Input) =>
  raw["mcp.tool.list"]({ query: { location: input?.["location"], server: input?.["server"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint13_2Request = Parameters<RawClient["server.mcp"]["mcp.tool.call"]>[0]
type Endpoint13_2Input = {
  readonly server: Endpoint13_2Request["params"]["server"]
  readonly name: Endpoint13_2Request["params"]["name"]
  readonly location?: Endpoint13_2Request["query"]["location"]
  readonly arguments?: Endpoint13_2Request["payload"]["arguments"]
}
...
type Endpoint13_3Request = Parameters<RawClient["server.mcp"]["mcp.resource.list"]>[0]
type Endpoint13_3Input = {
  readonly location?: Endpoint13_3Request["query"]["location"]
  readonly server?: Endpoint13_3Request["query"]["server"]
}
const Endpoint13_3 = (raw: RawClient["server.mcp"]) => (input?: Endpoint13_3Input) =>
  raw["mcp.resource.list"]({ query: { location: input?.["location"], server: input?.["server"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint13_4Request = Parameters<RawClient["server.mcp"]["mcp.resource.read"]>[0]
type Endpoint13_4Input = {
  ...
  readonly uri: Endpoint13_4Request["query"]["uri"]
}
...
type Endpoint13_5Request = Parameters<RawClient["server.mcp"]["mcp.connect"]>[0]
type Endpoint13_5Input = {
  readonly server: Endpoint13_5Request["params"]["server"]
...
type Endpoint13_6Request = Parameters<RawClient["server.mcp"]["mcp.disconnect"]>[0]
type Endpoint13_6Input = {
  readonly server: Endpoint13_6Request["params"]["server"]
  readonly location?: Endpoint13_6Request["query"]["location"]
}
const Endpoint13_6 = (raw: RawClient["server.mcp"]) => (input: Endpoint13_6Input) =>
...
const adaptGroup13 = (raw: RawClient["server.mcp"]) => ({
  ...
  listTools: Endpoint13_1(raw),
  callTool: Endpoint13_2(raw),
  listResources: Endpoint13_3(raw),
  readResource: Endpoint13_4(raw),
  connect: Endpoint13_5(raw),
  disconnect: Endpoint13_6(raw),
})

type Endpoint14_0Request = Parameters<RawClient["server.app"]["app.list"]>[0]
type Endpoint14_0Input = { readonly location?: Endpoint14_0Request["query"]["location"] }
const Endpoint14_0 = (raw: RawClient["server.app"]) => (input?: Endpoint14_0Input) =>
  raw["app.list"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint14_1Request = Parameters<RawClient["server.app"]["app.get"]>[0]
type Endpoint14_1Input = {
  readonly id: Endpoint14_1Request["params"]["id"]
  readonly location?: Endpoint14_1Request["query"]["location"]
}
const Endpoint14_1 = (raw: RawClient["server.app"]) => (input: Endpoint14_1Input) =>
  raw["app.get"]({ params: { id: input["id"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint14_2Request = Parameters<RawClient["server.app"]["app.ticket"]>[0]
type Endpoint14_2Input = {
  readonly id: Endpoint14_2Request["params"]["id"]
  readonly location?: Endpoint14_2Request["query"]["location"]
}
const Endpoint14_2 = (raw: RawClient["server.app"]) => (input: Endpoint14_2Input) =>
  raw["app.ticket"]({ params: { id: input["id"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

const adaptGroup14 = (raw: RawClient["server.app"]) => ({
  list: Endpoint14_0(raw),
  get: Endpoint14_1(raw),
  createTicket: Endpoint14_2(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  apps: adaptGroup14(raw["server.app"]),
